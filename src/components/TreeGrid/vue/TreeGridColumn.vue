<template>
  ...
  >
    ...
    <template slot-scope="scope" v-if="!Array.isArray(column.children)">
      ...
      <!--tag标签渲染-->
        <el-tag v-if="column.tag" :type=" column.tagRule?column.tagRule[scope.row[column.fieldName]][1] : '' ">
      ...
      <el-switch
        ...
        :active-value="column.switchData ? column.switchData.on : 1"
